...
Используйте ярлык **`drgr-bot`** на Рабочем столе (создаётся автоматически при установке), **или** дважды щёлкните **`ЗАПУСТИТЬ.bat`** в папке с ботом, **или** выполните в консоли:
