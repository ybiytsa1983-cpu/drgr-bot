...
### Chrome-расширение — вкладка «Статус» (VM + Ollama подключены)

![Расширение — Статус](https://github.com/user-attachments/assets/6d3f99b0-89d1-40cc-a3a6-eb3bd9b5d1da)

### Chrome-расширение — вкладка «Sandbox» (запрос к Ollama)

![Расширение — Sandbox](https://github.com/user-attachments/assets/5d11873b-b31f-4971-864e-8828ebf1a398)
