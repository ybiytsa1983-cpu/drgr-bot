...
|--------|------|---------------|
| **PowerShell (рекомендуется)** | [install.ps1](https://raw.githubusercontent.com/ybiytsa1983-cpu/drgr-bot/main/install.ps1) | См. ниже |
...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/ybiytsa1983-cpu/drgr-bot/main/install.ps1" -OutFile $f -UseBasicParsing
if (Test-Path $f) { & $f } else { Write-Host "Ошибка: файл не скачался. Проверьте интернет." -ForegroundColor Red }
```
