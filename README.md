...
| VM веб-интерфейс | Chrome-расширение | Управление ботом |
|:-:|:-:|:-:|
| ![VM веб-интерфейс](https://github.com/user-attachments/assets/eda4269c-0f9b-4848-b313-c3c32741fe30) | ![Chrome-расширение](https://github.com/user-attachments/assets/619cca13-e80f-42fe-b372-bd5121538d95) | ![Управление ботом](https://github.com/user-attachments/assets/e9fb9776-e466-408a-8b1e-e1ce418c3358) |

---

## ⚡ Установить / переустановить одной командой

> **Одна команда — без Git, без ручного скачивания файлов!**
> Работает и для первой установки, и для переустановки при ошибках.
...
> 🔧 **Ошибки `requirements.txt not found` или `vm\server.py not found`?**
> Запустите ту же команду выше — она переустановит всё правильно.
