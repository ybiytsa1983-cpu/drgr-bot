...
- **☄️ Local Comet** — веб-приложение быстрого доступа к статусу VM (`/local-comet/`)
...
### Одна команда (скачать + установить + запустить)
...
1. Клонирует репозиторий на Рабочий стол (`Desktop\drgr-bot`)
2. Установит зависимости Python
3. Создаст **DRGR.bat** на Рабочем столе для быстрого запуска
4. Запустит VM сервер на `http://localhost:5002`

### Вариант 2 — PowerShell (полный лаунчер)
...
├── extension/             # Local Comet — веб-приложение (доступно по /local-comet/)
│   ├── index.html
│   └── app.js
