...
|--------|------|---------------|
| **PowerShell (рекомендуется)** | [install.ps1](https://raw.githubusercontent.com/ybiytsa1983-cpu/drgr-bot/copilot/check-original-interface-and-bot-launch/install.ps1) | См. ниже |
...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/ybiytsa1983-cpu/drgr-bot/copilot/check-original-interface-and-bot-launch/install.ps1" -OutFile $f -UseBasicParsing
