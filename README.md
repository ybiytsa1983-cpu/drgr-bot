...
Если папка проекта пропала или бот не запускается — используйте скрипт экстренного восстановления:

```
ПОЧИНИТЬ.bat
```

> Скачайте его с GitHub: [ПОЧИНИТЬ.bat](https://github.com/ybiytsa1983-cpu/drgr-bot/raw/main/ПОЧИНИТЬ.bat)
