...
### Шаг 2 — Скачайте один файл

Скачайте **[СКАЧАТЬ.bat](https://github.com/ybiytsa1983-cpu/drgr-bot/raw/main/СКАЧАТЬ.bat)** и сохраните на Рабочий стол.
...
```powershell
irm https://github.com/ybiytsa1983-cpu/drgr-bot/raw/main/СКАЧАТЬ.bat -OutFile "$env:TEMP\download.bat"; Start-Process "$env:TEMP\download.bat"
```
