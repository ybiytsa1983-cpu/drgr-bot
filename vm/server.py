...
_DEFAULT_HTML_SYSTEM_PROMPT = (
    ...
    "'/* реализация */', 'console.log(\"not implemented\")'.\n"
    "Если задание содержит 3D-объекты, фигуры или анимации — используй "
    "встроенный JavaScript (Three.js через CDN или чистый Canvas/WebGL) "
    "и реализуй их ПОЛНОСТЬЮ с настоящей геометрией и анимацией.\n"
